                ...
                <nav class="navbar navbar-inverse main-color-1-bg" role="navigation">
                    <div class="container">
						...
						<div class="navbar-header">
                                                        <a class="logo" href="http://localhost/wordpress"><img src="http://localhost/wordpress/wp-content/uploads/2019/11/logo-fesj1.png " alt="logo"></a>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            if($logo!=''){
                                ...
                                <a href="<?php echo home_url() ?>" class="logo"><img src="<?php echo get_template_directory_uri()?>/http://localhost/wordpress/wp-content/uploads/2019/11/logo-fesj1.png" alt="<?php wp_title( '|', true, 'right' );?>"/></a>
                            <?php }
                            }?>
