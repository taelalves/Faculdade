          ...
          if ( ! isset( $page['hidden_page'] ) && $screen->id == $this->page_hook[$page['id']] ) {
            ...
            if ( $show_buttons ) {
              ...
              echo '<div id="option-tree-settings-api">';
				...
				echo '<span class="option-tree-ui-button button button-primary right document"><a target="_blank" href="http://university.cactusthemes.com/document/" >Documentation</a></span>';
				echo '<span class="option-tree-ui-button button button-primary grey right support"><a target="_blank" href="http://ticket.cactusthemes.com/">Support Forum</a></span>';
