...
if (!class_exists('cs_widget_data')) {
    ...
    class cs_widget_data {
        ...
        public static function enqueue_admin_scripts($hook) {
            ...
            wp_enqueue_script('widget_data', get_template_directory_uri() . '/include/assets/scripts/widget-data.js', '', '', true);
        ...
        public static function cs_import_widget_data() {
            ...
            $cs_upload_dir = get_template_directory() . '/include/theme-components/cs-widgets/import/import-widgets';
            ...
            echo '<p><strong>' . __('Widgets Imported Successfully.', 'LMS') . '</strong><br />';
        }
