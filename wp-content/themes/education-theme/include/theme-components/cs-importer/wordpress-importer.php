...
if (class_exists('WP_Importer')) {
    ...
    class WP_Import extends WP_Importer {
        ...
        function process_menu_item($item) {
			...
			if( isset($item['postmeta'][8]['key']) && $item['postmeta'][8]['key'] == '_menu_item_megamenu' ) {
				
				update_post_meta( $id, '_menu_item_megamenu', $item['postmeta'][8]['value'] );
			}
			if( isset($item['postmeta'][9]['key']) && $item['postmeta'][9]['key'] == '_menu_item_text' ) {
				
				update_post_meta( $id, '_menu_item_text', $item['postmeta'][9]['value'] );
			}
			if( isset($item['postmeta'][10]['key']) && $item['postmeta'][10]['key'] == '_menu_item_link' ) {
				
				update_post_meta( $id, '_menu_item_link', $item['postmeta'][10]['value'] );
			}
