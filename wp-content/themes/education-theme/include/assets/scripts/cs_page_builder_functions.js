		...
		var Data = [
			{ "Class" : "column_100" , "title":"100" , "element" : ["course_search","course","gallery", "slider","blog","cause", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "prayer", "advance_search", "parallax","table","call_to_action","flex_column","courses_categories","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus",'faq',"page_element","contentslider","highlight","list","members","piecharts","progressbars","register","tweets","tooltip","mesage","toggle"] },
			{ "Class" : "column_75" , "title" : "75" , "element" : ["course_search","course","gallery", "slider", "blog", "cause", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer","table","flex_column","courses_categories","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus",'faq',"page_element","contentslider","highlight","list","members","piecharts","progressbars","register","tweets","tooltip","mesage","toggle"] },
			{ "Class" : "column_67" , "title" : "67" , "element" : ["course_search","course","gallery", "slider", "blog", "cause", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable", "tabs", "accordion", "advance_search", "prayer", "pointtable","table","flex_column","courses_categories","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus",'faq',"page_element","contentslider","highlight","list","members","piecharts","progressbars","register","tweets","tooltip","mesage","toggle"] },
			{ "Class" : "column_50" , "title" : "50" , "element" : ["course_search","course","gallery", "slider", "blog", "cause", "event", "team", "column", "accordions", "team", "client", "contact", "column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable","tabs", "accordion", "advance_search", "prayer","teams","services","piechart","table","flex_column","courses_categories","clients","spacer","heading","testimonials","infobox","promobox","offerslider","audio","icons","contactus",'faq',"page_element","contentslider","highlight","list","members","piecharts","progressbars","register","tweets","tooltip","mesage","toggle"] },
			{ "Class" : "column_33" , "title" : "33" , "element" : ["course_search","gallery", "slider", "cause", "event", "team", "column", "accordions", "message_box",'image', "fixtures", "map", "video", "quote", "dropcap","services", "tabs", "accordion","prayer", "pointtable", "teams","flex_column","courses_categories", "pricetable","spacer","heading","testimonials","infobox","promobox","audio","icons","contactus","highlight","list","piecharts","tweets","tooltip","mesage","progressbars","toggle"] },
			{ "Class" : "column_25" , "title" : "25" , "element" : ["course_search","gallery","column", "divider", "message_box",'image', "image_frame", "map", "video", "quote", "dropcap", "pricetable","pastor","services","counter","teams",'services',"flex_column","courses_categories","spacer","heading","testimonials","infobox","promobox","audio","icons","contactus","highlight","list","piecharts","tweets","tooltip","mesage","progressbars","toggle"] },
		];
		...
		// Page Builder Post Categories ajax function	
		function cs_select_cat_views(post_id, id, admin_url) {
			'use strict';
			if (post_id) {
				var dataString = 'post_id=' + post_id +
					'&action=cs_dcpt_page_element_values';
				jQuery.ajax({
					type: "POST",
					url: admin_url,
					data: dataString,
					success: function(response) {
						jQuery("#dcpt-categories" + id).html(response);
						return false;
					}
				});
			}
		...
		// Dynamic Post Categories ajax function	
		function cs_select_dcpt_categories(post_id, id, admin_url) {
			'use strict';
			if (post_id) {
				var dataString = 'post_id=' + post_id +
					'&action=cs_dcpt_categories_values';
				jQuery.ajax({
					type: "POST",
					url: admin_url,
					data: dataString,
