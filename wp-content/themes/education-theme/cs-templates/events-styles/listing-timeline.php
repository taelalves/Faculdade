...
<div class="ev-inner">
    <div class="bullet-crl">
        <span class="fa-stack fa-lg">
            <i  class="fa fa-circle fa-stack-3x" style="color: #dbdbdb; font-size: 24px; position: relative; right: -8px; top: -9px; "></i>
            <i class="fa fa-circle fa-stack-2x" style=" font-size: 15px; top: 2px; left: -1px; color: #ffffff; "></i>
            <i class="fa fa-circle fa-stack-1x" style=" font-size: 7px; top: -10px; left: -1px; color: #355c7d; "></i>
        </span>
    </div>
    <div class="cstime">
       ...
       <div class="ev-left">
           <ul class="ev-option">
            <?php  if(isset($cs_dcpt_post_time) && $cs_dcpt_post_time == 'Yes'){?>
                  ...
                  <?php
				  get_template_part('cs-templates/events-styles/listing', 'categories');
                  }
				  ?>
           </ul>
        ...
        <?php if(isset($cs_event_meta->dynamic_post_location_address) && $cs_event_meta->dynamic_post_location_address <> ''){ ?>
                <li>
                    <i class="fa fa-map-marker"></i> <span><?php echo balanceTags($cs_event_meta->dynamic_post_location_address);?></span>
                </li>
        <?php }?>
       <?php
